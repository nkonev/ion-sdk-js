        ...
        this.streaming.on('data', (reply) => {
            ...
            switch (reply.getPayloadCase()) {
                case biz.SignalReply.PayloadCase.JOINREPLY:
                    const result = { success: ((_a = reply.getJoinreply()) === null || _a === void 0 ? void 0 : _a.getSuccess()) || false, reason: ((_b = reply.getJoinreply()) === null || _b === void 0 ? void 0 : _b.getReason()) || "unkown reason" };
                ...
                case biz.SignalReply.PayloadCase.PEEREVENT:
                    {
                        ...
                        const info = JSON.parse(utils_1.Uint8ArrayToString((_d = evt === null || evt === void 0 ? void 0 : evt.getPeer()) === null || _d === void 0 ? void 0 : _d.getInfo()));
                ...
                case biz.SignalReply.PayloadCase.MSG:
                    const data = JSON.parse(utils_1.Uint8ArrayToString((_g = reply.getMsg()) === null || _g === void 0 ? void 0 : _g.getData()));
